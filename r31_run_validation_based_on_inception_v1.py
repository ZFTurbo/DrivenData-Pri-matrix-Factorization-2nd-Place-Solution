...
'''
Validate Conv2D neural network for inception_v3 data and create train part for 2nd level features
'''

from a00_common_functions import *
from keras import __version__
print('Keras version: {}'.format(__version__))
from r21_create_keras_models_based_on_inception_v1 import ZF_full_keras_model_inception_v1
import math
...
def run_validation_func(nfolds):
    ...
    file_path = FEATURES_PATH + 'ZF_full_keras_model_inception_v1_train.csv'
...
'''
v1 
Fold 1 score: 0.03059595804998655
Fold 2 score: 0.030830853065500707
Fold 3 score: 0.03305906131310645
Fold 4 score: 0.034371353555204244
Fold 5 score: 0.03171038932109996
Score: 0.031641
'''