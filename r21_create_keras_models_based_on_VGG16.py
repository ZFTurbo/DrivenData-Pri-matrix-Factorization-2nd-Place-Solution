...
'''
Train neural net models based on recurrent GRU and features extracted with VGG16 pretrained model
'''
...
# Simple 1 GRU layer + Dropout
def ZF_full_keras_model_GRU_1024_VGG16_v11():
    from keras.models import Model
    from keras.layers import Input, Dense, GRU
    from keras.layers.core import Dropout

    inputs1 = Input((112, 512))
    x = GRU(1024, return_sequences=False, recurrent_dropout=0.5)(inputs1)
    x = Dropout(0.5)(x)
...
'''
v11 (Detailed)
Fold 1: 0.0241678279906
Fold 2: 0.024704297334
Fold 3: 0.0250997611484
Fold 4: 0.0251586844609
Fold 5: 0.0253942714073
'''