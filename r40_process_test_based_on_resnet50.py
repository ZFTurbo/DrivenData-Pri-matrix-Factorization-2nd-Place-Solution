...
'''
Process test data with LSTM neural network for Resnet50 data and create test part for 2nd level features.
'''
...
def process_tst(nfolds):
    ...
    subm.to_csv(FEATURES_PATH + 'ZF_full_keras_model_for_resnet_v4_test.csv')
