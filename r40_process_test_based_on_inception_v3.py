...
'''
Process test data with GRU neural network for inception_v3 data and create test part for 2nd level features.
...
def process_tst(nfolds):
    ...
    subm.to_csv(FEATURES_PATH + 'ZF_full_keras_model_inception_GRU_v4_test.csv')
...
def process_other_files(nfolds):
    ...
    file_path = FEATURES_PATH + 'ZF_full_keras_model_inception_GRU_v4_other.csv'
