...
'''
Validate LSTM neural network for resnet50 data and create train part for 2nd level features
'''

from a00_common_functions import *
from keras import __version__
print('Keras version: {}'.format(__version__))
from r21_create_keras_models_based_on_resnet50 import ZF_full_keras_model_for_resnet_v4
import math
...
def run_validation_func(nfolds):
    ...
    file_path = FEATURES_PATH + 'ZF_full_keras_model_for_resnet_v4_train.csv'
...
'''
v1 
Fold 1 score: 0.0401411544528839
Fold 2 score: 0.04036028115686745
Fold 3 score: 0.040364403436628025
Fold 4 score: 0.04055929151508116
Fold 5 score: 0.03990456410943038
Score: 0.040266
'''